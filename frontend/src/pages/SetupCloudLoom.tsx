...
const SetupCloudLoom = () => {
        ...
        <div className="space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            ...
            <ol className="list-decimal list-inside space-y-2 text-sm text-blue-700">
              ...
              <li>
                Select "Upload a template file" and choose your downloaded YAML
                file
              </li>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="bg-gray-900 text-green-400 p-3 rounded font-mono text-sm relative">
              <code>
                aws cloudformation create-stack --stack-name cloudloom-setup
              ...
              <Button
                ...
                onClick={() =>
                  navigator.clipboard.writeText(
                    "aws cloudformation create-stack --stack-name cloudloom-setup --template-body file://cloudformation-template.yaml --capabilities CAPABILITY_IAM"
                  )
                }
              >
        ...
        <div className="space-y-4">
          <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
            ...
            <ol className="list-decimal list-inside space-y-2 text-sm text-yellow-700">
              <li>
                Go to CloudFormation console and select your deployed stack
              </li>
              <li>Click on the "Outputs" tab</li>
              <li>
                Look for the output key named "CloudLoomRoleArn" or similar
              </li>
              <li>
                Copy the ARN value (format:
                arn:aws:iam::123456789012:role/CloudLoomRole)
              </li>
            </ol>
          </div>
          <div>
            <Label htmlFor="roleArn" className="text-base font-medium">
              Role ARN *
            </Label>
            <Input
              id="roleArn"
        ...
        <div className="space-y-4">
          <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
            ...
            <ul className="list-disc list-inside space-y-1 text-sm text-purple-700">
              ...
              <li>
                Supported: CloudFormation, Terraform, Kubernetes manifests
              </li>
              <li>CloudLoom will scan for security misconfigurations</li>
              <li>
                Repository must be accessible (public or with proper
                permissions)
              </li>
            </ul>
          </div>
          <div>
            <Label htmlFor="githubRepo" className="text-base font-medium">
  ...
  const handleComplete = async () => {
    if (!roleArn) {
      alert("Please fill in the Role ARN");
      return;
    }
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:5000/api/v1/configure/setup-cloudtrail",
        {
          method: "POST",
          headers: {
          ...
          body: JSON.stringify({
            arnNumber: roleArn,
            githubRepoLink: githubRepo ? githubRepo : undefined, // Only include if provided
          }),
        }
      );
      ...
      if (!response.ok) {
        ...
        alert(error.error || "Failed to submit configuration");
        return;
      }
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Complete these steps to get CloudLoom monitoring your infrastructure
          </p>
        </div>
